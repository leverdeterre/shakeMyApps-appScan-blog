...
---
Crew (inc.speramus.ios.crew) AppScan description of the content of the iOS application Crew (inc.speramus.ios.crew). This analysis is based on the Mobile App Tools : AppScore, static analysis, Audit and the Mobile Audit App Tool.
