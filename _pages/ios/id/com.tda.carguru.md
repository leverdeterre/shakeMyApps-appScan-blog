...
---
Car Connect (com.tda.carguru) AppScan description of the content of the iOS application Car Connect (com.tda.carguru). This analysis is based on the Mobile App Tools : AppScore, static analysis, Audit and the Mobile Audit App Tool.
