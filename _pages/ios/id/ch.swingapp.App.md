...
---
AppScan generated a spoiler description of the content of the iOS application Swing'App (ch.swingapp.App). This analysis is based on the Mobile App Tools : AppScore, Audit and the Mobile Audit App Tool.
