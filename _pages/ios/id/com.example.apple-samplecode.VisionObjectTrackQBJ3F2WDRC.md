...
---
NearbyDetective (com.example.apple-samplecode.VisionObjectTrackQBJ3F2WDRC) AppScan description of the content of the iOS application NearbyDetective (com.example.apple-samplecode.VisionObjectTrackQBJ3F2WDRC). This analysis is based on the Mobile App Tools : AppScore, static analysis, Audit and the Mobile Audit App Tool.
