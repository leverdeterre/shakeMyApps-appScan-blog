...
---
Plonq (ae.plonq) AppScan description of the content of the iOS application Plonq (ae.plonq). This analysis is based on the Mobile App Tools : AppScore, static analysis, Audit and the Mobile Audit App Tool.
