...
---
Uber Eats (com.ubercab.UberEats) AppScan description of the content of the iOS application Uber Eats (com.ubercab.UberEats). This analysis is based on the Mobile App Tools : AppScore, static analysis, Audit and the Mobile Audit App Tool.
