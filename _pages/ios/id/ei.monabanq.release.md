...
---
Monabanq (ei.monabanq.release) AppScan description of the content of the iOS application Monabanq (ei.monabanq.release). This analysis is based on the Mobile App Tools : AppScore, static analysis, Audit and the Mobile Audit App Tool.
